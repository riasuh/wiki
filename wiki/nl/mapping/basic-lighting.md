...
|     ![Afbeelding van de Rocket League omgeving](~@images/mapping/rocket_env.jpg)     | **Rocket League Environment**<br /> **Info.dat naam:** `RocketEnvironment`<br /> **Standaard kleuren:** Oranje & Blauw<br /><br /> **Lasers:** :white_check_mark: (links & rechts)<br /> **Ring Spin:** :x:<br /> **Ring Zoom:** :x:<br /> **Equalizer:** :x: <br /><br /> **Video voorbeeld:** [YouTube](https://youtu.be/C6bDsdNTRVk)                                                                                                                                                                                                                                                                                                                                                                                                                       |
...
|  ![Afbeelding van de Kaleidoscope omgeving](~@images/mapping/kaleidoscope_env.jpg)   | **Kaleidoscope Environment**<br /> **Info.dat naam:** `KaleidoscopeEnvironment`<br /> **Standaard kleuren:** Rode & Zwarte blokken, Rode & Witte lichten, Rode & Magenta boost lichten<br /><br /> **Lasers:** :white_check_mark: <br /> **Ring Spin:** :white_check_mark:<br /> **Ring Zoom:** :white_check_mark:<br /> **Equalizer:** :x:<br /><br /> **Video voorbeeld:** [YouTube](https://youtu.be/4f8CLg77PCo) <br /> **Official bekendmaking & tutorial**: [YouTube](https://youtu.be/eZBd7-yb284)                                                                                                                                                                                                                                           |
|    ![Afbeelding can de Interscope omgeving](~@images/mapping/interscope_env.jpg)     | **Interscope Environment**<br /> **Info.dat naam:** `InterscopeEnvironment`<br /> **Standaard kleuren:** gele & Roze blokken, Paarse & Witte lichten, Koel Rode & Koel Witte boost lichten<br /><br /> **Lasers:** :white_check_mark: <br /> **Ring Spin:** :white_check_mark: (auto's) <br /> **Ring Zoom:** :white_check_mark: (auto's en extra laser snelheid) <br /> **Equalizer:** :white_check_mark:<br /> **Opmerking:** dit is de eerste omgeving dat gebruik maakt van 6, 7, 16 en 17. 6 en 7 besturen extra lichten. 16 en 17 besturen de hydraulica van de auto's. <br /><br />**Video voorbeeld:** [YouTube](https://youtu.be/ILILJHnSg_U)<br /> **Officiële bekendmaking & tutorial**: [YouTube](https://youtu.be/BhMQ8KS2rZk) |
|  ![Afbeelding van de Glass Desert omgeving](~@images/mapping/glass-desert_env.jpg)   | **Glass Desert Environment**<br /> **Info.dat naam:** `GlassDesertEnvironment`<br /> **Standaard kleuren:** Gele & Roze blokken, Blauwe & Licht Blauwe lichten<br /><br /> **Lasers:** :white_check_mark: <br /> **Ring Spin:** :x:<br /> **Ring Zoom:** :x:<br /> **Equalizer:** :white_check_mark:<br /> **Opmerking:** dit is de eerste 360&deg; omgeving. 360 levels MOETEN dit gebruiken en het is niet te gebruiken voor standaard levels. Ring Light position controleert de horizontale buitenste rails. Back Top Laser position controleert de zes rails aan de bovenkant. <br /><br />**Video voorbeeld:** [YouTube](https://youtu.be/3jUYN8Di-gU)                                                                                          |
