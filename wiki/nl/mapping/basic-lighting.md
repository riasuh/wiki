...
|    ![Afbeelding can de Interscope omgeving](~@images/mapping/interscope_env.jpg)     | **Interscope Environment**<br /> **Info.dat naam:** `InterscopeEnvironment`<br /> **Standaard kleuren:** gele & Roze blokken, Paarse & Witte lichten, Koel Rode & Koel Witte boost lichten<br /><br /> **Lasers:** :white_check_mark: <br /> **Ring Spin:** :white_check_mark: (auto's) <br /> **Ring Zoom:** :white_check_mark: (auto's en extra laser snelheid) <br /> **Equalizer:** :white_check_mark:<br /> **Opmerking:** dit is de eerste omgeving dat gebruik maakt van 6, 7, 16 en 17. 6 en 7 besturen extra lichten. 16 en 17 besturen de hydraulica van de auto's. <br /><br />**Video voorbeeld:** [YouTube](https://youtu.be/ILILJHnSg_U) <br /> **Officiële bekendmaking & tutorial**: [YouTube](https://youtu.be/GmJpF2VA-6E) |
